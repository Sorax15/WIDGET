    ...
    <div class="expert-wrapper px-16 w-full">
        ...
        <div class="mb-8 flex flex-row">
            <div class="flex flex-row justify-between">
                    ...
                    <div class="list-experts">
                        <div class="flex flex-row item-expert select">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="badge w-fit simple">4.8 <i class="fa-solid fa-star"></i></div>
                            </div>
                        </div>
                ...
                <div class="h-full separator w-px"></div>
            </div>
...
@section('scripts')
    <script type="text/javascript">
        function onSelectSalesPerson() {
            window.location.replace('{{ route("sales-details") }}');
        }
    </script>
@endsection

...
@section('content')
    <div class="wrapper-welcome w-full relative">
        <div class="absolute cursor-pointer top-2 right-9 phone:top-0  phone:right-0">
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="flex flex-row expert mb-2.5">
                ...
                <div class="flex flex-col">
                    <div class="name theme-color-2-fc">Amber Brock</div>
                    <div class="role mb-1.5 common-color-4-fc">Sales Agent</div>
                </div>
            </div>

            <div class="p1 mb-9 font-medium theme-color-4-fc phone:mb-0 ">
            ...
            <div class="learn-more"><a href="#">Learn more about me</a></div>
            ...
            <div class="grid grid-rows-3 grid-cols-2 phone:grid-rows-5 phone:grid-cols-1 gap-y-9">
        ...
        <div class="phone:hidden question-icon fixed cursor-pointer theme-color-2-bg common-color-1-fc bottom-9 right-9 rounded-xl pt-2.5 px-3 pb-3" onclick="onOpenQuestionDialog()">

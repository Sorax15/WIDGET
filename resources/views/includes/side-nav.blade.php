...
{{--                    </a>--}}
        ...
        <div id="progressClose"
             class="progress-close flex flex-col justify-center rounded-r-full mr-2 py-2.5 pl-5 pr-9">
            <i class="fa-solid fa-circle-check progress-close-white"></i>
